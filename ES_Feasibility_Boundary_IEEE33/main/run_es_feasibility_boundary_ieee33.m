...
new_root   = fileparts(script_dir);                     % .../ES_Feasibility_Boundary_IEEE33/
...
addpath(genpath(repo_root));    % existing helpers (build_distflow..., solve_es_socp..., etc.)

out_base  = fullfile(new_root, 'results', 'es_feasibility_boundary_ieee33');
