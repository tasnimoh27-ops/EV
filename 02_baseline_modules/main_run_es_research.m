...
if ~exist('./04_results/module_outputs/main_runner/tables','dir'), mkdir('./04_results/module_outputs/main_runner/tables'); end
if ~exist('./04_results/module_outputs/main_runner/figures','dir'), mkdir('./04_results/module_outputs/main_runner/figures'); end
if ~exist('./04_results/module_outputs/main_runner/mat_files','dir'), mkdir('./04_results/module_outputs/main_runner/mat_files'); end
...
if run_vis_ranking
    ...
    writetable(T_vis,'./04_results/module_outputs/main_runner/tables/voltage_impact_ranking.csv');
    ...
    grid on;
    saveas(fig_vis,'./04_results/module_outputs/main_runner/figures/voltage_impact_score_bar.png');
    close(fig_vis);
...
fprintf('  Mat     -> 04_results/module_outputs/main_runner/mat_files/\n\n');

% Print key result files
tbl_files = dir('./04_results/module_outputs/main_runner/tables/*.csv');
for f = tbl_files'
    fprintf('  %s\n', f.name);
end
